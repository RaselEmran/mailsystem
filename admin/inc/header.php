...
$admin  = new Admin();
    ...
    switch($_SERVER['PHP_SELF'])  {
        ...
        case '/mail/print.php': 
            $title = 'Invoice Print'; 
            break;
        case '/mail/portfolio.php': 
            $title = 'Portfolio'; 
            break;
        case '/mail/staff.php': 
            $title = 'Staff'; 
            break;
        case '/mail/contact.php': 
            $title = 'Contact us'; 
            break;
								...
								<ul class="nav nav-main">
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="all-people.php">
													All People
												</a>
											</li>
											<!-- <li>
												<a href="all-leaber.php">
													All Leabour 
												</a>
											</li>
											 <li>
												<a href="daily-leabour.php">
													Daily Leabour
												</a>
											</li>
											<li>
												<a href="daily-leabour-due.php">
													 Daily Leabour Due
												</a>
											</li>
											<li>
												<a href="monthly-leabour.php">
													 Monthly Leabour
												</a>
											</li>
											<li>
												<a href="monthly-pay.php">
													 Monthly Leabour Pay
												</a>
											</li> -->
